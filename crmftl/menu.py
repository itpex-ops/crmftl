ROLE_MENUS = {
    ...
    'superadmin': ['dashboard', 'enquiry', 'orders', 'vehicles', 'accounts','vehicle_accounts','accounts_customer','accounts_bank','orders_manual'],

    'admin': ['dashboard', 'enquiry', 'orders', 'vehicles','orders_manual'],
